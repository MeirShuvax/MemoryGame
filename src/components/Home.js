...
//The home component that contains the game menu, the buttons,
// and other things related to the home, gives options by clicking the buttons to see results,
// start a new game, and more
function Home() {
